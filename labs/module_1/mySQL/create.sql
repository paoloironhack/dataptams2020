...
CREATE TABLE customer (ID int, Customer_ID VARCHAR(30), Name VARCHAR(30), Phone VARCHAR(20), Email VARCHAR(30), Address VARCHAR(30), City VARCHAR(20), State_Province VARCHAR(30), Country VARCHAR(20), ZIP_Postal_code VARCHAR(15));
